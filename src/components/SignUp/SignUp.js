        ...
        <div className='w-5/6 mx-auto flex justify-center my-3'>
            <div className='lg:w-[40%] md:w-[50%] w-[80%] p-2 border-2 rounded'>
                ...
                <form action="" className=''>
                    ...
                    <input type="text" name='name' className='border-b-2 mb-2 p-2 w-full outline-none bg-gray-100 rounded'/><br />
                    ...
                    <input type="text" name='confirmPassword' className='border-b-2 mb-2 p-2 w-full outline-none bg-gray-100 rounded'/><br />
                    ...
                    <input type="submit" value="Sign Up" className='p-2 bg-gray-300 w-full rounded-lg font-bold cursor-pointer'/>
                </form>
